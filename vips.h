...
int vips_resize_go(VipsImage *in, VipsImage **out, double scale, double vscale);
int vips_resize_with_premultiply(VipsImage *in, VipsImage **out, double scale, double vscale);
